-- ==========================================
-- Geulssiin Art Center - Full Database Schema v10
-- (Includes all previous updates + fixes)
-- ==========================================
...
-- Ensure columns exist (Idempotent for existing updates)
do $$
begin
...
-- Reset Profile Policies to ensure freshness
...
-- ==========================================
-- 2. SITE CONFIG (Admin Text Management)
-- ==========================================
...
-- Fix Site Config Policies (Allow Admin Insert for Upsert)
...
-- Seed Data (will skip if key exists)
...
-- ==========================================
-- 4. CLASSES (Flexible Schedule)
-- ==========================================
create table if not exists public.classes (
  id bigint generated by default as identity primary key,
  day text not null,          -- '월', '화', '수'...
  start_time text default '00:00', -- '10:00'
  end_time text default '00:00',   -- '12:00'
...
-- ! CRITICAL FIX: Ensure Table Structure aligns with new code (remove time_range if exists) !
do $$
begin
    ...
    -- Drop legacy column that causes Insert Errors
